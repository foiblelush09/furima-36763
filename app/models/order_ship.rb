class OrderShip
  ...
  def save
    ...
    Ship.create(postalcode: postalcode, prefecture_id: prefecture_id, city: city, address: address, building_name: building_name, phonenumber: phonenumber, order_id: order_id)
  end
end